      ...
      if (empty($_POST["email"])) {
        ...
        if (filter_var($emailTemp, FILTER_VALIDATE_EMAIL)) {
          ...
          $mobile = getSafeValue($con, $_POST['mobile']);
              ...
              $mobileErr = "Phone number must be exactly 10 digits";
            }
          }
                    ...
                    <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                        ...
                        <form class="mx-1 mx-md-4" method="post" autocomplete="off">
                            ...
                            <div class="d-flex align-items-center mb-2">
                                ...
                                <div class="form-floating flex-fill">
                                    <input type="text" pattern="[0-9]{10}" maxlength="10" class="form-control"
                                        id="mobile" name="mobile" placeholder="1234567890" value="<?php echo $mobileAuto ?>"
                                        required />
                                    <label for="mobile">Mobile Number (10 digits)</label>
                                </div>
                            </div>
                            <?php echo '<p style="color: red" class="ms-5">' . $mobileErr . '</p>' ?>
