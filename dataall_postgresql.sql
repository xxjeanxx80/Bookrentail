-- PostgreSQL dump converted from MySQL dataall.sql
...
-- Dumping structure for table admin_tokens
...
-- Dumping structure for table books
CREATE TABLE books (
  id SERIAL,
  ...
  best_seller INTEGER DEFAULT NULL,
...
-- Dumping structure for table contact_us
...
-- Dumping structure for table order_detail
...
-- Dumping structure for table order_status
...
-- Dumping structure for table user_tokens
...
-- Dumping data for table user_tokens: ~0 rows (approximately)