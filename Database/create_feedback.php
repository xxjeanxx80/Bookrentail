...
if (mysqli_query($con, $sql)) {
    ...
    if (mysqli_query($con, $constraintSql)) {
        echo "✅ Rating constraint added successfully!\n";
    } else {
        echo "⚠️  Warning: Could not add rating constraint (may already exist): " . mysqli_error($con) . "\n";
    }
    
} else {
    echo "❌ Error creating feedback table: " . mysqli_error($con) . "\n";
}
