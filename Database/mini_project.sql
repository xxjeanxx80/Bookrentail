...
(1, 'tqhien614@gmail.com', '123'),
(2, 'tienduc@gmail.com', '123');
...
(10, 11, 15, 280.00, 13),
(12, 13, 1, 200.00, 10),
(13, 14, 23, 22400.00, 10),
(14, 15, 24, 27500.00, 10);
...
(5, 'Gaurav Singh', 'gauravnegi9634@gmail.com', 9368963477, '2025-11-23 15:36:35', '29be54a52396750258d886abc5417fda'),
(6, 'Charu Rawat', 'charu@gmail.com', 1234567890, '2025-11-25 15:10:27', '560f9bb94e9f9fc27d85f0175eff2d5c'),
(9, 'Gaurav Sharma', 'gs0896614@gmail.com', 7830508740, '2025-12-13 05:10:00', '29be54a52396750258d886abc5417fda'),
(10, 'Nikhil Parki', 'nikhilparki31@gmail.com', 9156104828, '2025-12-20 07:10:52', '350d89c1cd6592bbbd1ed2e8a4f3ddba'),
(11, 'Vaibhav Pradhan', 'vaibhav@gmail.com', 1234567890, '2025-12-22 06:10:12', '23b431acfeb41e15d466d75de822307c');
*/
...
ALTER TABLE books ADD PRIMARY KEY (id, ISBN);
...
ALTER TABLE order_status ADD PRIMARY KEY (id), ADD UNIQUE (status_name);
...
ALTER SEQUENCE admin_id_seq RESTART WITH 3;

-- AUTO_INCREMENT for table books
ALTER SEQUENCE books_id_seq RESTART WITH 26;

-- AUTO_INCREMENT for table categories
ALTER SEQUENCE categories_id_seq RESTART WITH 42;

-- AUTO_INCREMENT for table contact_us
ALTER SEQUENCE contact_us_id_seq RESTART WITH 24;

-- AUTO_INCREMENT for table orders
ALTER SEQUENCE orders_id_seq RESTART WITH 16;

-- AUTO_INCREMENT for table order_detail
ALTER SEQUENCE order_detail_id_seq RESTART WITH 15;

-- AUTO_INCREMENT for table order_status
ALTER SEQUENCE order_status_id_seq RESTART WITH 7;
