...
CREATE DATABASE IF NOT EXISTS `mini_project` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `mini_project`;

-- Dumping structure for table mini_project.admin
...
-- Dumping data for table mini_project.admin: ~2 rows (approximately)
INSERT INTO `admin` (`id`, `email`, `password`) VALUES
	(1, 'tqhien614@gmail.com', '202cb962ac59075b964b07152d234b70'),
	(2, 'tienduc@gmail.com', '202cb962ac59075b964b07152d234b70');

-- Dumping structure for table mini_project.admin_tokens
...
-- Dumping data for table mini_project.admin_tokens: ~0 rows (approximately)

-- Dumping structure for table mini_project.books
...
-- Dumping data for table mini_project.categories: ~31 rows (approximately)
INSERT INTO `categories` (`id`, `category`, `status`) VALUES
	(3, 'Computing, Internet & Digital Media', 1),
	(7, 'Action & Adventure1', 1),
...
-- Dumping structure for table mini_project.contact_us
...
-- Dumping data for table mini_project.contact_us: ~3 rows (approximately)
INSERT INTO `contact_us` (`id`, `name`, `email`, `mobile`, `message`, `date`) VALUES
	(17, 'Tran Minh Duc', 'tmduc@gmail.com', 7280980667, 'Loved it', '2025-11-09 15:41:13'),
	(18, 'Tran Xuan Tien', 'nikhilparki31@gmail.com', 9149104828, 'good website loved it', '2025-10-10 07:12:16'),
	(19, 'To Lam', 'vaibhav@gmail.com', 1234567890, 'Your website is very good.', '2025-09-22 06:11:22'),
	(24, 'TRAN MINH DUC', 'admin@demo.test', 1111111111, '123123', '2025-11-10 20:38:14');

-- Dumping structure for table mini_project.feedback
...
-- Dumping data for table mini_project.feedback: ~0 rows (approximately)
INSERT INTO `feedback` (`id`, `order_id`, `book_id`, `user_id`, `rating`, `comment`, `created_at`) VALUES
	(1, 19, 13, 14, 5, 'tuyệt', '2025-12-02 14:56:34');

-- Dumping structure for table mini_project.orders
...
-- Dumping data for table mini_project.orders: ~2 rows (approximately)
INSERT INTO `orders` (`id`, `user_id`, `address`, `address2`, `pin`, `payment_method`, `total`, `payment_status`, `order_status`, `date`, `duration`) VALUES
	(16, 13, 'Phuong Uong Bi, Tinh QuangNinh', '102 Nguyen Trai', 200000, 'COD', 22400, 'success', 4, '2025-11-10 19:39:03', 10),
	(17, 13, 'Phuong Uong Bi, Tinh QuangNinh', '102 Nguyen Trai', 200000, 'COD', 700, 'success', 5, '2025-11-10 20:24:49', 60),
	(18, 13, 'Phuong Uong Bi, Tinh QuangNinh', '102 Nguyen Trai', 200000, 'COD', 200, 'success', 4, '2025-11-10 20:34:43', 10),
	(19, 14, 'Phuong Uong Bi, Tinh QuangNinh', '102 Nguyen Trai', 200000, 'COD', 1001400, 'success', 5, '2025-11-16 14:22:16', 100),
	(20, 14, 'Phuong Uong Bi, Tinh QuangNinh', '102 Nguyen Trai', 200000, 'COD', 45200, 'success', 4, '2025-11-17 09:32:51', 10),
	(21, 14, 'Phuong Uong Bi, Tinh QuangNinh', '102 Nguyen Trai', 200000, 'COD', 200, 'success', 5, '2025-12-02 13:37:32', 10),
	(22, 14, 'Phuong Uong Bi, Tinh QuangNinh', '102 Nguyen Trai', 200000, 'COD', 124413, 'success', 6, '2025-12-09 12:57:45', 100);

-- Dumping structure for table mini_project.order_detail
...
-- Dumping data for table mini_project.order_detail: ~11 rows (approximately)
INSERT INTO `order_detail` (`id`, `order_id`, `book_id`, `price`, `time`) VALUES
	...
	(16, 17, 1, 700, 60),
	(17, 18, 1, 200, 10),
	(18, 19, 13, 1001400, 100),
	(19, 20, 25, 45200, 10),
	(20, 21, 1, 200, 10),
	(21, 22, 26, 124413, 100);

-- Dumping structure for table mini_project.order_status
...
-- Dumping data for table mini_project.order_status: ~6 rows (approximately)
...
-- Dumping data for table mini_project.users: ~1 rows (approximately)
INSERT INTO `users` (`id`, `name`, `email`, `mobile`, `doj`, `password`) VALUES
	(14, 'TRAN MINH DUC', 'duc@gmail.com', 906129223, '2025-11-16 13:34:53', '202cb962ac59075b964b07152d234b70'),
	(15, 'TRAN MINH Hien', 'hien@gmail.com', 123456789, '2025-11-17 09:53:48', '202cb962ac59075b964b07152d234b70');

-- Dumping structure for table mini_project.user_tokens
...
-- Dumping data for table mini_project.user_tokens: ~0 rows (approximately)
